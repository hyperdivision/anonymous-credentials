...
class RevocationInfo {
  ...
  encode (buf, offset) {
    ...
    curve.encodeG1(this.acc, buf, offset)
    offset += curve.encodeG1.bytes

    curve.encodeG1(this.updatedAcc, buf, offset)
    offset += curve.encodeG1.bytes
  ...
  static decode (buf, offset) {
    ...
    info.acc = curve.decodeG1(buf, offset)
    offset += curve.decodeG1.bytes

    info.updatedAcc = curve.decodeG1(buf, offset)
    offset += curve.decodeG1.bytes

    info.y = curve.decodeScalar(buf, offset)
    offset += curve.decodeScalar.bytes
