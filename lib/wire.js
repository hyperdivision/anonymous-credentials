...
const { CertificatePublicKey, AccumulatorPublicKey } = require('./keygen')
...
var PublicCertification = module.exports.PublicCertification = class PublicCertification {
  constructor (opts) {
    this.pk = opts.pk
    this.certId = opts.certId
...
var Identifier = module.exports.Identifier = class Identifier {
  constructor (id = {}, pk) {
    this.y = id.y
    this.w = id.witness || {}
    this.pk = pk
...
var SimpleProof = module.exports.SimpleProof = class SimpleProof {
...
var WitnessProof = module.exports.WitnessProof = class WitnessProof {
  constructor (opts = {}) {
    this.U = opts.U
    this.C = opts.C
    this.C1 = opts.C1
  ...
  encode (buf, offset) {
    ...
    for (let i = 0; i < 4; i++) {
      curve.encodeG1(this.U[i], buf, offset)
      offset += curve.encodeG1.bytes  
    }
  ...
  static decode (buf, offset) {
    ...
    const U = []
    for (let i = 0; i < 4; i++) {
      U.push(curve.decodeG1(buf, offset))
      offset += curve.decodeG1.bytes
    }
